            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <Button
                  size="sm"
                  variant="ghost"
                  className="flex w-12 h-12 sm:w-13 sm:h-13 rounded-xl text-neutral-800 hover:text-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-100 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-all duration-200 shadow-sm border border-neutral-200/50 dark:border-neutral-700/50"
                >
                  <SkipBack className="h-6 w-6 sm:h-7 sm:w-7" fill="currentColor" strokeWidth={0} />
                </Button>
                ...
                <Button
                  ...
                  className="flex w-12 h-12 sm:w-13 sm:h-13 rounded-xl text-neutral-800 hover:text-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-100 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-all duration-200 shadow-sm border border-neutral-200/50 dark:border-neutral-700/50"
                >
                  <SkipForward className="h-6 w-6 sm:h-7 sm:w-7" fill="currentColor" strokeWidth={0} />
        ...
        {isExpanded && (
          <div className="px-4 py-6 sm:px-6 sm:py-8 max-h-[85vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between mb-6 sm:mb-8">
              ...
              <div className="flex items-center gap-4">                {/* Volume Control in Top Right */}
